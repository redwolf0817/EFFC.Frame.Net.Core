...
namespace EFFC.Frame.Net.Module.Extend.WeixinWeb.Logic
{
    ...
    public abstract partial class WeixinAuthorizationLogic : AuthorizationLogic
    {
        ...
        public class WeixinHelper : WechatHelper
        {
            ...
            public WeixinHelper(WeixinAuthorizationLogic logic) : base("", "", "")
            {
                _logic = logic;
                ...
                Mch_ID = ComFunc.nvl(_logic.CallContext_Parameter.ExtentionObj.weixin.mch_id);
                Mch_Key = ComFunc.nvl(_logic.CallContext_Parameter.ExtentionObj.weixin.mch_key);
            ...
            public string ScanCodeInfo
            {
                get
                {
                    return ComFunc.nvl(_logic.CallContext_Parameter[DomainKey.POST_DATA, "ScanCodeInfo"]);
                }
            }
            /// <summary>
            /// 扫描类型，一般是qrcode
            ...
            public string ScanType
            {
                get
                {
                    return ComFunc.nvl(_logic.CallContext_Parameter[DomainKey.POST_DATA, "ScanType"]);
                }
            }
            /// <summary>
            /// 扫描结果，即二维码对应的字符串信息
            ...
            public string ScanResult
            {
                get
                {
                    return ComFunc.nvl(_logic.CallContext_Parameter[DomainKey.POST_DATA, "ScanResult"]);
                }
            }
            /// <summary>
            ...
            {
                return ComFunc.nvl(_logic.CallContext_Parameter[DomainKey.POST_DATA, key]);
            }
