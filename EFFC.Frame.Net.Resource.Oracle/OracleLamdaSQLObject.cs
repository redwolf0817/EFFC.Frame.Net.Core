...
{
    public class OracleLamdaSQLObject : LamdaSQLObject<OracleDLRColumn>
    {
        public OracleLamdaSQLObject(string table, SqlOperatorFlags sqlflags) : base(table, sqlflags)
        {
        }
        ...
        protected override object Convert2DateTime(object[] args)
        {
            ...
            var rtn = LinqDLRColumn.New<OracleDLRColumn>("", this, SqlFlags);
            object value = null;
