...
namespace EFFC.Frame.Net.Base.Data.Base
{
    ...
    /// </summary>
    [Serializable]
    public abstract partial class BaseCollection : System.ICloneable, IEnumerable<KeyValuePair<string, object>>,IDisposable
    {
        ...
        {
            BaseCollection rtn = DeepCopy<BaseCollection>();
            return rtn;
        }
        /// <summary>
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public virtual T DeepCopy<T>() where T : BaseCollection
        {
