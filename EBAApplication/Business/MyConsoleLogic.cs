...
namespace EBAApplication.Business
{
    public partial class MyConsoleLogic:ScheduleLogic
    {
        MyDBHelper _db;
        /// <summary>
        /// db操作相关
        ...
        public class MyDBHelper : DBHelper
        {
            ...
            public new LinqDLRTable PSQLLamdaTable(string tablename, string alianname = "", DBType dbtype = DBType.PostgreSQL)
            {
                ...
                return LinqDLRTable.New<PostgreSqlDLRColumn>(tablename, alianname, new PostgreSqlOperatorFlags());
            }
            /// <summary>
            /// 创建一个默认的DB访问参数
            /// </summary>
