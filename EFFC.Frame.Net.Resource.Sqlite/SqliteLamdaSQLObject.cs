...
{
    public class SqliteLamdaSQLObject : LamdaSQLObject<SqliteDLRColumn>
    {
        public SqliteLamdaSQLObject(string table, SqlOperatorFlags sqlflags) : base(table, sqlflags)
        {
        }
        ...
        protected override object Convert2DateTime(object[] args)
        {
            ...
            var rtn = LinqDLRColumn.New<SqliteDLRColumn>("", this, SqlFlags);
            object value = null;
            if (args.Length == 1)
            {
            ...
            var express = $"datetime({rtn.Convert2Express(value)})";
