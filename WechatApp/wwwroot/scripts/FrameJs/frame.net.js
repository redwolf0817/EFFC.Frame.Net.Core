    ...
    fns.Net = {
        ...
        ResponseDataPreProcess: function (options,repdata, resolve, reject) {
		    ...
		    if (obj && obj.ErrorCode != null) {
                if (obj.ErrorCode == "") {
                    if (FrameNameSpace.Config.Ajax && FrameNameSpace.Config.Ajax.successAction) {
                        if(FrameNameSpace.Config.Ajax.successAction(options, obj)){
                            resolve(obj.Content);
                        }
                    } else {
                        resolve(obj.Content);
                    ...
                    if (FrameNameSpace.Config.Ajax && FrameNameSpace.Config.Ajax.failAction) {
                        if (FrameNameSpace.Config.Ajax.failAction(options, obj.ErrorCode, obj.ErrorMessage)) {
                            reject({
